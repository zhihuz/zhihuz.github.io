...
```yml
# Site settings
title: Zhihuz Blog             # title of your website
SEOTitle: Zhihuz Blog          # check out docs for more detail
...
For instance, [Hello 2015])(https://zhihuz.cn/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://zhihuz.cn/2019/09/08/spacemacs-workflow/) with
...
![](http://zhihuz.cn/img/blog-sidebar.jpg)
...
![](http://zhihuz.cn/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://zhihuz.cn/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“Zhihuz Blog”** but I want the title shows in search engine is **“黄玄的博客 | Zhihuz Blog”** which is multi-language.
...
- Brand new [Archive](https://zhihuz.cn/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
<img src="http://zhihuz.cn/img/blog-md-navbar.gif" width="320" />
