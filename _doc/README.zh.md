...
**[在这里预览模板 &rarr;](http://zhihuz.cn/huxblog-boilerplate/)**
...
```
# Site settings
title: Zhihuz Blog             # 你的博客网站标题
SEOTitle: Zhihuz Blog			# 在后面会详细谈到
...
ga_domain: zhihuz.cn			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“Zhihuz Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Zhihuz Blog”** ，这个就需要SEO Title来定义了。
